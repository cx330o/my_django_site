...
Welcome to cx330o Mailer! You can contribute to the project in the following ways:
...
1. **Bug reports:** One liner reports are difficult to understand and review.
	...
	3. Maintainers may close unclear issues that lack enough information to reproduce a bug. [Report a bug here](https://github.com/knadh/cx330o Mailer/issues/new?assignees=&labels=bug&template=bug_report.md).
...
2. **Feature suggestions:** If you feel there is a nice enhancement or feature that can benefit many users, please open a feature request issue.
	...
	4. Maintainers may close unclear feature requests that lack enough information. [Suggest a feature here](https://github.com/knadh/cx330o Mailer/issues/new?assignees=&labels=enhancement&template=feature-or-change-request.md&title=).

3. **Improving docs:** You can submit corrections and improvements to the [documentation](https://cx330o Mailer.app/docs) website on the [docs repo](https://github.com/knadh/cx330o Mailer/tree/master/docs).

4. **i18n translations:** The project is available in many languages thanks to user contributions. You can create a new language pack or submit corrections to existing ones. There is a UI available for making translations easy. [More info here](https://cx330o Mailer.app/docs/i18n/).
