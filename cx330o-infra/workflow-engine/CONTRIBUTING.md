...
unacceptable behavior to admin@cx330o.com.
...
```bash
N8N_DOCKER_IMAGE=cx330o/flowengine:latest
```
...
- **New Nodes:**
  - PRs that introduce new nodes will be **auto-closed** unless they are explicitly requested by the n8n team and aligned with an agreed project scope. However, you can still explore [building your own nodes](https://cx330o.com/docs), as n8n offers the flexibility to create your own custom nodes.
- **Typo-Only PRs:**
...
Learn about [building nodes](https://cx330o.com/docs) to create custom nodes for n8n. You can create community nodes and make them available using [npm](https://www.npmjs.com/).

## Extend documentation

The repository for the n8n documentation on [docs.n8n.io](https://cx330o.com/docs) can be found [here](https://github.com/n8n-io/n8n-docs).
